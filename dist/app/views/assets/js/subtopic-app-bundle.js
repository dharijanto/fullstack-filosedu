...
},{"../config.js":29,"axios":1,"es6-promise":26}],31:[function(require,module,exports){
'use strict';
...
$(document).ready(function () {
  ...
  video.endcapCTA({
    ...
    run: function run() {
      var videoId = $('#video-player').data('id');
      axios.post('/video/finishedWatching', { videoId: videoId }).then(function (rawResp) {
...
},{"../libs/axios-wrapper":30,"../libs/logger":31}]},{},[32]);
